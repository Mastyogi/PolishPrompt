import { BookOpen, Zap, Wand2, MapPin, MessageCircle, Bug, Cpu, KeyRound, LayoutTemplate } from "lucide-react";
    ...
    <section id="inside" className="px-4 py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold sm:text-4xl">What's Inside The <span className="text-gradient-gold">Ebook</span></h2>
          <p className="mt-3 text-muted-foreground">21 days. One ebook. A complete AI-powered operating system.</p>
        </div>
